...
import { AuthService, LoginDetails } from '@/modules/auth/auth.service';
import { UAParser } from 'ua-parser-js'; // Phân tích user agent từ máy để lấy thông tin về browser, device, os
  ...
  (data, context: ExecutionContext): LoginDetails => {
    ...
    return {
      ...
      deviceType:
        ...
        '',
      deviceOS:
        userAgent.os.name || (request.headers.devicetype as string) || '',
    };
  },
);
